...
public class EmailService {
    ...
    public void sendVerificationEmail(String toEmail, String username, String token) {
        ...
        String verificationLink = "https://certifai-backend.onrender.com/certifai/auth/verify?token=" + token;
    ...
    public void sendPasswordResetEmail(String toEmail, String username, String token) {
        ...
        String resetLink = "https://certifai-backend.onrender.com/certifai/auth/reset-password?token=" + token;
